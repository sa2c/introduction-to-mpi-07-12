...
carpentry: "sa2c_mpi"    # what kind of Carpentry (must be either "lc", "dc", "swc", "sa2c" or "sa2c_mpi")
venue: "Bay Campus"        # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "July 12th, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00am - 5:00pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-07-12      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-07-12        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
scw_project: "scw1447 "  # project code for the SCW training project for this event
instructor: ["Jarno Rantaharju"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Michele Mesiti"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
recon_channel: https://recon.swansea.ac.uk/#narrow/stream/38-Introduction-to-MPI-2019-07-12       # optional: url for specific recon channel to join
---
